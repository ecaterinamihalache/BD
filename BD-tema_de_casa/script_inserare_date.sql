...
INSERT INTO Contracte VALUES(NULL, TO_DATE('24.07.2016', 'DD.MM.YYYY'), NULL, 30, (select id_cabinet FROM Cabinete WHERE denumire='MEDLIFE'));
INSERT INTO Contracte VALUES(NULL, TO_DATE('11.11.2019', 'DD.MM.YYYY'), NULL, 18, (select id_cabinet FROM Cabinete WHERE denumire='MEDLIFE'));
INSERT INTO Contracte VALUES(NULL, TO_DATE('13.01.2007', 'DD.MM.YYYY'), NULL, 24, (select id_cabinet FROM Cabinete WHERE denumire='MEDLIFE'));
INSERT INTO Contracte VALUES(NULL, TO_DATE('07.05.2003', 'DD.MM.YYYY'), NULL, 60, (select id_cabinet FROM Cabinete WHERE denumire='MEDLIFE'));
INSERT INTO Contracte VALUES(NULL, TO_DATE('07.05.2003', 'DD.MM.YYYY'), NULL, 36, (select id_cabinet FROM Cabinete WHERE denumire='MEDLIFE'));
INSERT INTO Contracte VALUES(NULL, TO_DATE('07.05.2005', 'DD.MM.YYYY'), NULL, 42, (select id_cabinet FROM Cabinete WHERE denumire='MEDLIFE'));
INSERT INTO Contracte VALUES(NULL, TO_DATE('03.01.2005', 'DD.MM.YYYY'),TO_DATE('03.07.2005', 'DD.MM.YYYY') , 66, (select id_cabinet FROM Cabinete WHERE denumire='MEDLIFE'));
INSERT INTO Contracte VALUES(NULL, TO_DATE('21.01.2012', 'DD.MM.YYYY'),TO_DATE('21.07.2012', 'DD.MM.YYYY') , 48, (select id_cabinet FROM Cabinete WHERE denumire='MEDLIFE'));
...
INSERT INTO Analize VALUES(NULL, 'Standard',  TO_DATE('23.09.2019', 'DD.MM.YYYY'), TO_DATE('24.09.2019', 'DD.MM.YYYY'),(SELECT id_cabinet FROM Cabinete WHERE denumire='MEDLIFE'),(SELECT id_medic FROM Medici_lab WHERE nume_m='RUSU'),(SELECT id_asistenta FROM Asistente WHERE nume_a='PIRVU'),80);
INSERT INTO Analize VALUES(NULL, 'Hematologie', TO_DATE('11.03.2018', 'DD.MM.YYYY'), TO_DATE('12.03.2018', 'DD.MM.YYYY'),(SELECT id_cabinet FROM Cabinete WHERE denumire='MEDLIFE'),(SELECT id_medic FROM Medici_lab WHERE nume_m='DANILIUC'),(SELECT id_asistenta FROM Asistente WHERE nume_a='CAUNIC'),95);
INSERT INTO Analize VALUES(NULL, 'Imunologie', TO_DATE('29.06.2020', 'DD.MM.YYYY'), TO_DATE('29.06.2020', 'DD.MM.YYYY'),(SELECT id_cabinet FROM Cabinete WHERE denumire='MEDLIFE'),(SELECT id_medic FROM Medici_lab WHERE nume_m='BALAN'),(SELECT id_asistenta FROM Asistente WHERE nume_a='ROTARU'),150);
INSERT INTO Analize VALUES(NULL, 'Electroforeza',  TO_DATE('30.05.2017', 'DD.MM.YYYY'), TO_DATE('30.05.2017', 'DD.MM.YYYY'),(SELECT id_cabinet FROM Cabinete WHERE denumire='MEDLIFE'),(SELECT id_medic FROM Medici_lab WHERE nume_m='DUMITRESCU'),(SELECT id_asistenta FROM Asistente WHERE nume_a='MELINTE'),170);
INSERT INTO Analize VALUES(NULL, 'Hepatice', TO_DATE('14.11.2017', 'DD.MM.YYYY'), TO_DATE('15.11.2017', 'DD.MM.YYYY'),(SELECT id_cabinet FROM Cabinete WHERE denumire='MEDLIFE'),(SELECT id_medic FROM Medici_lab WHERE nume_m='POROSNIUC'),(SELECT id_asistenta FROM Asistente WHERE nume_a='PARVULESCU'),40);
INSERT INTO Analize VALUES(NULL, 'Generale', TO_DATE('24.03.2019', 'DD.MM.YYYY'), TO_DATE('24.03.2019', 'DD.MM.YYYY'), (SELECT id_cabinet FROM Cabinete WHERE denumire='MEDLIFE'),(SELECT id_medic FROM Medici_lab WHERE nume_m='BALAUCA'),(SELECT id_asistenta FROM Asistente WHERE nume_a='NICHITA'),90);
INSERT INTO Analize VALUES(NULL, 'Anemie', TO_DATE('11.05.2015', 'DD.MM.YYYY'), TO_DATE('12.05.2015', 'DD.MM.YYYY'), (SELECT id_cabinet FROM Cabinete WHERE denumire='MEDLIFE'),(SELECT id_medic FROM Medici_lab WHERE nume_m='PUIU'),(SELECT id_asistenta FROM Asistente WHERE nume_a='SANDU'),60);
...
INSERT INTO Pacienti_Analize VALUES((SELECT id_pacient FROM Pacienti WHERE nume_p='ROSU'),(SELECT id_analiza FROM Analize WHERE tip='Hepatice'));
INSERT INTO Pacienti_Analize VALUES((SELECT id_pacient FROM Pacienti WHERE nume_p='MIHALACHE'),(SELECT id_analiza FROM Analize WHERE tip='Generale'));
